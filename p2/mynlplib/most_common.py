...
# def t2_given_t1(tag2, tag1, TRAIN_FILE):
#     tags = [t for (words, t) in conll_seq_generator(TRAIN_FILE)]
#     count_t2_t1 = 0
#     #print(len(tags[0]))
#     for i in range(len(tags)):
#       tags[i].insert(0, START_TAG)
#       tags[i].append(END_TAG)
#     for i in range(len(tags)):
#       for index in range(len(tags[i])-1):
#         if tags[i][index]==tag1 and tags[i][index+1] == tag2:
#           count_t2_t1 += 1
#     return count_t2_t1#(count_t2_t1, count_t1)
